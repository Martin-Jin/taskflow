        ...
        >
          {tab === 'dashboard' && (
            <DashboardPage
              ...
              /* The review is passed whenever it has content; `weeklyReviewDue`
                 decides prompt vs. quiet reopen row (see WeeklyReviewCard). */
              weeklyReview={weekly.canOpen ? weekly.review : null}
              weeklyReviewDue={weekly.nudgeVisible}
