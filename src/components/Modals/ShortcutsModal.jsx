...
import { Search, Keyboard, RotateCcw, Pencil, X } from 'lucide-react';
...
export default function ShortcutsModal({ onClose }) {
  ...
  return (
    <Modal onClose={onClose} ariaLabel="Keyboard shortcuts" size="lg" variantClassName="modal-stat-list modal-shortcuts" title="Keyboard shortcuts">
      ...
      {filteredDefs.length === 0 ? (
        <EmptyState>No shortcuts match "{query}".</EmptyState>
      ) : (
      ...
      {error && <p style={{ fontSize: 12, color: 'var(--color-danger)', marginTop: 8, marginBottom: 0 }}>{error}</p>}
