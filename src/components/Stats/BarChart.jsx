...
export default function BarChart({ data, valueFormatter = (v) => v.toFixed(1), barColor = 'var(--accent)', emptyMessage = 'No data yet.' }) {
        ...
        return (
          ...
          >
            ...
            <div
              style={{
                fontSize: 10.5,
                color: d.isToday ? 'var(--accent-hover)' : 'var(--text-tertiary)',
